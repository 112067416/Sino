...
<html>
	<head>
		...
		function outExcel() {
			...
			if(window.self == window.top) wo.LoadOriginalFile("./outEtlSbExcel.do?"+content, "xls");
			else wo.LoadOriginalFile("<%=request.getContextPath()%>/sino/etl/sj/outEtlSbExcel.do?"+content, "xls");
