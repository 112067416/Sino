...
<head>
		...
		<!--
			contextmenu.putMenus("menu", [["修改", "edit.gif", "toModify()"],["分解", "edit.gif", "toDivied()"],["删除", "del.gif", "doDel()"]]);
			...
			function doDhno(obj){
				...
				ajax.post("getFpdhInfo.do", postContent);
			}
			//-->
		</SCRIPT>
	</head>
	<body>
<ui:page title="红字发票管理">
<f:page action="indexHzfp.do" file="listHzfp.jsp">
...
<td><ui:date name="chriBegin" />至<ui:date name="chriEnd" /></td>
...
<ui:panel id="Detail" title="编辑红字发票" popup="true" display="false" closable="true">
<form name="DataForm" method="post" action="editHzfp.do" >
