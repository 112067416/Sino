...
<td><ui:input name="dhno" title="订货No." maxlength="7" value="entity.dhno" required="true" readonly="true" />-<ui:input name="line" title="行号" maxlength="2" required="true" value="entity.line" readonly="true" /></td>
<th style="text-align: left;">出货日期</th> 
<td><ui:date name="chri" showCalendar="true" value="entity.chri" required="true" readonly="true" /></td>
<th style="text-align: left;">合同客户</th> 
<td><ui:input name="name" title="合同客户名称" value="entity.name" readonly="true" /></td>
</tr>
<tr>
...
<colgroup><col width="20%"/><col width="14%"/><col width="14%"/><col width="14%"/><col width="12%"/><col width="12%"/><col width="14%"/></colgroup>
<tr>
...
<td nowrap="nowrap"><ui:number name="kfzl" value="entity.kfzl" scale="7" precision="3" title="开票吨数" required="true" onchange="calculate(this);"/></td>
<td nowrap="nowrap"><ui:input name="fpno" value="entity.fpno" title="发票号" maxlength="10" required="true"/></td>
<td nowrap="nowrap"><ui:number name="kpdj" value="entity.kpdj" scale="9" precision="4" maxlength="10" title="发票单价" required="true" onchange="calculate(this);"/></td>
<td nowrap="nowrap"><ui:number name="lxzr" value="entity.lxzr" scale="8" precision="2" maxlength="9" title="利息折扣" onchange="calculate(this);"/></td>
<td nowrap="nowrap"><ui:number name="zlzr" value="entity.zlzr" scale="8" precision="2" maxlength="9" title="质量折扣"  onchange="calculate(this);"/></td>
...
<div class="opt-btm">
<!-- 
<input type="button" class="button" value="分 解" onclick="doInsert();" /> 
<input type="button" class="button" value="删 除" onclick="doDelete(this);" /> -->
