...
<html>
	<head>
		...
		function doQuery(el) {
			...
			var postContent = coco.parseParams([{name : "jbno",value: jbno},{name : "flag",value: true}]);
	...
	<ui:page title="现品情报作成">
		...
		<form name="DataForm" xu.ajax="" xu.r="" xu.color="1" method="post" action="saveXp.do">
			...
			<tr>
				<td colspan="6">
					...
					<tr>
						...
						<th>新现品NO</th>
						<td><ui:input value="newJbno" name="newJbno" maxlength="11" required="true" /></td>
						<td colspan="7" style="text-align: left;"><input type="hidden" name="xpzkName" /><input type="hidden" name="ched"/><input type="hidden" name="chno"/><input type="hidden" name="scbj" /></td>
					</tr>
					<tr>
						<th>
							现品尺寸
