...
<body>
	<ui:page title="采购导入 ">
		<form name="DataForm" xu.ajax="" method="post" action="cgdr.do" >
			...
			<tr>
				<th style="text-align: left;">签约日</th>
				<td><ui:date name="qyri" cssStyle="width: 120;" /></td>
				<th style="text-align: left;">合同日</th>
				<td><ui:date name="htdt" cssStyle="width: 120;" /></td>
				<th style="text-align: left;">币种</th>
				<td nowrap="nowrap"><sys:codeBox code="#013" name="thqf" txt="2" value="thqf" /></td>
			</tr>
			<tr>
				<th style="text-align: left;">商社</th>
				<td colspan="5"><sys:codeBox code="#010" name="ssno" width="500" match="true" dat="3" txt="2" tofield="[[1,'ssnm']]" /><input type="hidden" name="ssnm" /></td>
			</tr>
			<tr>
				<th style="text-align: left;">导入文件</th>
				<td><ui:attach id="wwht" attachName="attachId" label="上传Excel" width="100" single="true" typeFilter="#excel#" /></td>
				<td colspan="4">&nbsp;</td>
			</tr>
			</table>
