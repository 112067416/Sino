...
<html>
	<head>
		...
		function outExcel() {
			...
			if(window.self == window.top) wo.LoadOriginalFile("./outBlmxExcel.do?"+content, "xls");
			else wo.LoadOriginalFile("<%=request.getContextPath()%>/sino/ss/outBlmxExcel.do?"+content, "xls");
