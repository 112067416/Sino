...
<body>
<ui:page title="制品出货车牌号导入 ">
	<form name="DataForm" xu.ajax="" method="post" action="cprk.do" >
		<table width="98%" align="center" style="margin: 20px auto;" class="form">
			...
			<tr>
				...
				<td><ui:attach id="cprk" attachName="attachId" label="上传Text" width="100" single="true" typeFilter="#text#" /></td>
				<td colspan="2">&nbsp;</td>
			</tr>
		</table>
