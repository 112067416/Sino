...
<html>
	<head>
		...
		function outExcel() {
			...
			if(window.self == window.top) wo.LoadOriginalFile("./outRChtjExcel.do?"+content, "xls");
			else wo.LoadOriginalFile("<%=request.getContextPath()%>/sino/yygl/khyf/outRChtjExcel.do?"+content, "xls");
