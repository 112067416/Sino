...
<table width="100%" class="pagination1" border="0" cellpadding="0" cellspacing="0">
	<colgroup>
		<col width="3%"/><col width="12%"/><col width="7%"/><col width="10%"/>
		<col width="5%"/><col width="4%"/><col width="8%"/><col width="5%"/>
		<col width="6%"/><col width="8%"/><col width="8%"/><col width="7%"/><col width="5%"/><col width="7%"/><col width="5%"/></colgroup>
	...
	<c:forEach varStatus="stat" var="item" items="${page.datas }">
		<tr id0="${item.id }" dhno="${item.dhno }" line="${item.line }" xu.menu="menu" <c:if test="${stat.index%2 == 1 }">class="odd"</c:if> ondblclick="toFpzs(this);" title="双击分配" onmouseover="overTr(this)" onmouseout="outTr(this)">
