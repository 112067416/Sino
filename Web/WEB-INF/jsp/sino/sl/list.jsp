...
<table id="DataTbl" width="100%" align="center" style="margin-top: 10px;"
	class="pagination">
	<colgroup><col width="13%" /><col width="10%" /><col width="10%" /><col width="5%" /><col width="5%" /><col width="10%" /><col width="5%" /><col width="5%" /><col width="5%" /><col width="5%" /><col width="10%" /><col width="5%" /><col width="12%" /></colgroup>
	<tr>
		<th>PILE No.</th>
		<th>订货号</th>
		<th>生产线</th>
