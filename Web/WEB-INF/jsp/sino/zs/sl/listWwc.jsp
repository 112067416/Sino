...
<table id="DataTbl" width="100%" align="center" class="pagination">
<colgroup>
...
<c:forEach varStatus="stat" var="item" items="${page.datas}">
	<tr xu.menu="menu" xu.id="${item.zsno }" <c:if test="${stat.index%2 == 1 }">class="odd"</c:if> <c:if test="${item.wsjz>0}">style="background-color:#FFD39B;"</c:if> <c:if test="${item.vsjz>0}">style="background-color:#7FFFD4;"</c:if> onmouseover="overTr(this)" onmouseout="outTr(this)" >
