...
function find() {
	...
	ajax.post("zpk!list.do", coco.parseParam("dhno", dhno.value));
}
...
<form name="DataForm" >
	<table width="96%" align="center" class="form"
		...
		<tr>
			<th>制品No.</th>
			<td><ui:input name="jbno" maxlength="11" />&nbsp;&nbsp;<input type="button" class="button" value="打印(P)" onclick="printNo(this);" accesskey="p" /></td>
			<td></td>
			<th>订货合同行号</th>
