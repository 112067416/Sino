...
%><table no="" align="center"  cellspacing="0" cellpadding="0" border="0" >
	<colgroup><col width="650" /><col width="40" /><col width="310" /></colgroup>
	<tr>
		<td height="350px" style="border: 0px solid #000000;">
		<table width="100%" cellspacing="0" cellpadding="2" border="0" bordercolor="#000000" style="border-collapse: collapse;">
			<colgroup>
				<col width="25%" />
				<col width="22%" />
				<col width="25%" />
			...
			<tr>
				<td height="42px" colspan="4" style="font-size: 14px;">
					 <span style="visibility: hidden;">用户</span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
			</tr>
			<tr>
				<td height="40px" style="border-right: 0px; font-size: 14px;" colspan="2">
					<span style="visibility: hidden;">商品名</span> <span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
				<td style="border-right: 0px; font-size: 14px; ">
					<span style="visibility: hidden;">等级</span>&nbsp;&nbsp;<span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
				<td style="border-right: 0px; font-size: 14px; ">
					<span style="visibility: hidden;">Package No.</span>&nbsp;&nbsp;<span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
			</tr>
			<tr>
				<td height="40px" colspan="2" style="border-right: 0px; font-size: 14px; ">
					<span style="visibility: hidden;">规格</span> &nbsp;&nbsp;<span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
				<td colspan="2" style="border-right: 0px; font-size: 14px;">
					<span style="visibility: hidden;">镀锡量 </span>&nbsp;&nbsp;<span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
			</tr>
			<tr height="30px">
				<td height="40px" colspan="2" style="border-right: 0px; font-size: 14px;">
					<span style="visibility: hidden;">尺寸</span> &nbsp;&nbsp;<span style="font-size: 24px; font-weight: bold;" ></span>
				</td>
				<td colspan="2" style="font-size: 14px;">
					<span style="visibility: hidden;">表面精加工</span>&nbsp;&nbsp;<span style="border-left: 0px; font-size: 24px; font-weight: bold;" ></span>
				</td>
			</tr>
			<tr>
				...
				<td style="border-right: 0px; font-size: 14px;">
					<span style="visibility: hidden;">长(批量)</span>&nbsp;&nbsp;<span style="border-left: 0px; font-size: 24px; font-weight: bold;" ></span>
				</td>
				<td style="border-right: 0px; font-size: 14px;">
			...
			<tr>
				...
				<td valign="top" style="font-size: 14px;" >
					...
					<div style="font-size: 30px; font-weight: bold;" ><c:if test=""></c:if></div>
				</td>
			</tr>
			<tr>
		...
		<td style="border: 0px solid #000000;">
			<table height="100%" width="100%" cellspacing="0" cellpadding="1" border="0" bordercolor="#000000" style="border-collapse: collapse;">
				<colgroup>
					<col width="30%" />
					<col width="17%" />
					<col width="30%" />
				...
				<tr>
					...
					<td colspan="3" style="border-left: 0px;font-size: 19px; font-weight: bold;" ></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="border-left: 0px; font-size: 19px; font-weight: bold;" ></td>
				...
				<tr>
					<td height="70" colspan="4" valign="top" >
						<div style="height: 15px; font-size: 14px;"><span style="visibility: hidden;">订货号</span>&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size: 19px; font-weight: bold;"><c:if test=""> </c:if></span></div>
					</td>
				</tr>
			</table>
		</td>
